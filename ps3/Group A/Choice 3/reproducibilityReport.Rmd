...
> I was able to reprodice the findings.My upper and lower confidence intervals were slightly off however I felt that my reproduction was sufficiently similar to the original findings.

How difficult was it to reproduce your results? 

> As someone who is new to both R and statistics, these findings were quite difficult to reproduce. I worked with a few other students from the course as we talked throguh our thought processes and shared our approches. This was the sole reason I was able to complete this reproduction in the alotted time of 3 hours. If I had not had others to bounce ideas off of, I would have taken significatnly longer and would not have been able to complete the reproduction in 3 hours.


What aspects made it difficult? What aspects made it easy?

> As stated above, having others to code with made this assignmnet significantly more easy.That being said, finding a data set that was already tidy and has most preprocessing done made the assignment easier. Aspects that made this assignment difficult were simply that I wasn't entirely sure where I should have looked (in terms of pacakcges) for functions to complete the calculation I needed. Having a better understanding of statistics would hae made this assignment easier.