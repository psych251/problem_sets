...
`gather` these datasets into long ("tidy data") form and get rid of the Xs in the headers. If you need to review tidying, [here's the link to R4DS](http://r4ds.had.co.nz/tidy-data.html) (bookmark it!). Remember that you can use `select_helpers` to help in your `gather`ing. 
...
## **Optional**: Your own analysis

If you are interested, dig in further. 
